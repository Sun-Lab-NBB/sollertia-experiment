...
_CCW_ROTATION_CODE: int
_TTL_ON_CODE: int
_VALVE_OPEN_CODE: int
_VALVE_CLOSED_CODE: int
_VALVE_CALIBRATED_CODE: int
...
class WaterValveInterface(ModuleInterface):
    ...
    _transmitted_parameters: tuple[np.uint32, np.uint16, np.uint32] | None
