...
class RuntimeControlUI:
    ...
    def _run_ui_process(
        self, mode: VisualizerMode, *, has_reinforcing_trials: bool, has_aversive_trials: bool, has_mesoscope: bool
    ) -> None: ...
...
class _ControlUIWindow(QMainWindow):
    ...
    _generate_reference_button: QPushButton | None
