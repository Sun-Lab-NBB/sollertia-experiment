...
MESOSCOPE_VR_SESSIONS: tuple[SessionTypes, ...]
...
class MesoscopeCameras:
    ...
    face_camera_configuration_path: Path = ...
    ...
    body_camera_configuration_path: Path = ...
...
class MesoscopeAcquisition:
    z_step_um: int = ...
    z_range_um: tuple[int, int] = ...
    z_exclusion_um: tuple[int, int] = ...
    acquisition_order: _MesoscopeAcquisitionOrder = ...
    registration_channel: int = ...
    field_curvature_correction: bool = ...
    frames_per_reference_plane: int = ...
    zstack_scale_factor: float = ...
