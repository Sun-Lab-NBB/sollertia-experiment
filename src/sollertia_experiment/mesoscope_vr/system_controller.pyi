...
from .acquisition_components import (
    ...
    TrialState as TrialState,
    MesoscopeVRLogMessageCodes as MesoscopeVRLogMessageCodes,
...
_MAXIMUM_RUNTIME_STATE_CODE: int
...
class MesoscopeVRSystem:
    ...
    _SPEED_CALCULATION_WINDOW_MS: int
    _SOURCE_ID: np.uint8
    _started: bool
    _terminated: bool
    _paused: bool
