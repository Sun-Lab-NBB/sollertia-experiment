...
_TRIAL_OUTCOME_EMPTY: np.int8
_TRIAL_OUTCOME_FAILURE: np.int8
_TRIAL_OUTCOME_SUCCESS: np.int8
_TRIAL_OUTCOME_GUIDED: np.int8
...
class _BlitManager:
    _canvas: FigureCanvasAgg
    _figure: Figure
    _animated_artists: list[Line2D]
    _background: Any
    _connection_id: int
