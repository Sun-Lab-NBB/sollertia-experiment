...
def load_vr_task_template(unity_scene_name: str) -> TaskTemplate:
    ...
    Notes:
        ...
        configure templates' CLI command. The directory typically points to the local sollertia-virtual-reality
        repository copy. The template file name is expected to match the Unity scene name with a '.yaml' suffix.
